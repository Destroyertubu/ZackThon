/* eslint-disable no-control-regex -- Validate model configuration without accepting control bytes. */
import { createHash } from 'node:crypto';
import type { Answer, ConnectionStatus, Highlight, HighlightResponse } from '../../src/features/galaxy/types.js';
import { sourceLiterals } from './source-format.js';

const MAX_HIGHLIGHTS = 6;
const MAX_MODEL_CHARACTERS = 12_000;
const MAX_MODEL_RESPONSE_BYTES = 64_000;
// Keep rich quotes intact within a hard limit; oversized literals remain in the reader.
