...
export class SynthesisService {
  private active = 0;
  constructor(private readonly content: ContentService, private readonly limits = { global: 50, perCode: 10 }, private readonly now = Date.now) {}
  async generate(raw: unknown, actor: string) {
    ...
    this.content.store.reserve('ai', actor, this.limits.global, this.limits.perCode);
    this.active++;
    try {
