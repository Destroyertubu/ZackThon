...
/** Mature CC0 Jacaranda: all 116,084 source leaf islands, baked placement, about 438k triangles. */
export default function LivingStarTree({ reducedMotion }: { reducedMotion: boolean }) {
  ...
  useFrame((_, delta) => { if (!reducedMotion) advanceUniform(time, delta) })
  return <group name="star-tree-jacaranda" position={[TREE_POSITION[0], GARDEN_TREE_ROOT_Y, TREE_POSITION[2]]}>
