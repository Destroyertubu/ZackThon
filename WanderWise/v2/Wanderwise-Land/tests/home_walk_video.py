...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'docs/home-upgrade/evidence';TMP=Path('/private/tmp/wanderwise-walk-video');TMP.mkdir(exist_ok=True)
with sync_playwright() as p:
 ...
 page.goto('http://127.0.0.1:18091/home');page.bring_to_front();page.wait_for_function('()=>wanderwiseDiagnostics?.().sceneState==="ready"');page.wait_for_timeout(1200)
 ...
 for key,ms in [('w',500),('a',550),('d',550),('s',500)]:
